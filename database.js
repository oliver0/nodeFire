db.users.insert(
   [
    ...
    { email: 'oliveralexander00email@gmail.com', clearanceLevel: 4 }, // Your Google Email added here
    { email: 'lemme.seeplz@gmail.com', clearanceLevel: 2 }, // Your Other Google Email added here
